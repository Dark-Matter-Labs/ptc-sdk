...
export declare enum SesBounceType {
    Undetermined = "Undetermined",
    Permanent = "Permanent",
    Transient = "Transient"
}
export declare enum SesBounceSubType {
    Undetermined = "Undetermined",
    General = "General",
    NoEmail = "NoEmail",
    Supressed = "Supressed",
...
export declare enum SesComplaintFeedbackType {
    abuse = "abuse",
...
export declare enum RuleTarget {
    space = "space",
    spaceEvent = "space_event"
}
export declare enum SpaceEventStatus {
    pending = "pending",
    ...
    completeWithIssueResolved = "complete_with_issue_resolved"
}
export declare enum TimeSortBy {
    timeAsc = "time-asc",
    timeDesc = "time-desc"
}
export declare enum SpaceApprovedRuleSortBy {
    popularity = "popularity",
    timeAsc = "time-asc",
    timeDesc = "time-desc"
}
export declare enum SpaceEventRuleSortBy {
 ...
 * Time unit divider: '-'
 */
export declare enum RuleBlockType {
    /**
...
export declare enum RuleBlockContentDivider {
    array = ";",
    type = "^",
    time = "-",
    operator = ":"
}
export declare enum NoiseLevel {
    high = "high",
    medium = "medium",
    low = "low"
}
export declare enum SpaceEventAccessType {
    publicFree = "public:free",
    publicPaid = "public:paid",
    privateFree = "private:free",
    privatePaid = "private:paid"
}
export declare enum SpaceEquipmentType {
    facility = "facility",
    general = "general",
    audio = "audio",
    video = "video",
...
export declare enum PermissionRequestStatus {
    pending = "pending",
    queued = "queued",
    assigned = "assigned",
...
export declare enum PermissionRequestResolveStatus {
...
export declare enum UserNotificationTarget {
...
export declare enum UserNotificationTemplateName {
    /**
     * <Welcome>
     * Greet a new user
...
export declare enum PermissionResponseStatus {
    pending = "pending",
    approved = "approved",
...
export declare enum PermissionResponseVoteDecision {
    approved = "approved",
    approvedWithCondition = "approved_with_condition",
    rejected = "rejected",
    abstention = "abstention"
...
export declare enum SpaceEventReportQuestion {
...
export declare enum SpaceHistoryType {
    create = "create",
    update = "update",
...
export declare enum SpaceEventImageType {
    list = "list",
    thumbnail = "thumbnail",
    cover = "cover"
}
